...
<div class="main-panel">
    ...
    @endcomponent
        <form class="form-sample" id="addBlogCat" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2 text-center">
                                <img id="image" src="{{asset('public/b-category/default.jpg')}}" width="100px" height="100px">
                            </div>        
                        </div>
                    </div>
                </div>
